    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="用户编号" align="center" key="userId" prop="userNumber" v-if="columns[0].visible"/>
    ...
    <el-dialog :title="title" v-model="open" width="800px" append-to-body>
      <el-form :model="form" :rules="rules" ref="userRef" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="用户编号" prop="userNumber">
              <el-input v-model="form.userNumber" placeholder="请输入用户编号" maxlength="30"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
const data = reactive({
  ...
  rules: {
    ...
    userNumber: [{required: true, message: "用户姓名不能为空", trigger: "blur"}],
...
function handleUpdate(row) {
  ...
  if (row && row.userId) {
    ...
    if(selectList.value.length === 1) {
      userId = selectList.value[0].userId
    }
  }
